...
class Encuesta_GeneradorController extends Zend_Controller_Action
{
    ...
    private $elementDecorators = null;

    private $elementButtonDecorators = null;

    private $subformDecorators = null;

    private $formDecorators = null;

    private $decoratorsPregunta = null;

    private $decoratorsPreguntaS = null;

    private $decoratorsGrupo = null;

    private $decoratorsSeccion = null;
