        	         ...
        	         "questions":[
        	            {
        	               ...
        	               "rows":[
        	                  {
        	                     "value":"35",
        	                     "text":"¿Es importante lo que estás aprendiendo y comprendes cómo se relaciona con otras materias  y temas?"
        	                  },
        	                  {
        	                     "value":"36",
        	                     "text":"¿En esta materia fue clara la forma de evaluación?"
        	                  },
        	                  {
        	                     "value":"33",
        	                     "text":"¿Conoces las reglas de comportamiento dentro del salón de clases?"
        	                  },
        	                  {
        	                     "value":"34",
        	                     "text":"¿Las reglas de comportamiento son aplicadas cuando es necesario?"
        	                  },
        	                  {
        	                     "value":"37",
        	                     "text":"¿El maestro las motiva constantemente para tener un mejor desempeño? "
        	                  },
        	                  {
        	                     "value":"38",
        	                     "text":"¿Las metas que pone el maestro son retadoras pero al mismo tiempo alcanzables? "
        	                  },
        	                  {
        	                     "value":"39",
        	                     "text":"¿En el salón de clases se atienden las necesidades de cada una de las alumnas? "
        	                  },
        	                  {
        	                     "value":"40",
        	                     "text":"¿Sientes que el maestro reconoce tus logros y tus dificultades? "
        	                  },
        	                  {
        	                     "value":"41",
        	                     "text":"¿El maestro fomenta la participación y eres escuchada y tomada en cuenta? "
        	                  },
        	                  {
        	                     "value":"42",
        	                     "text":"¿El maestro genera experiencias para colaborar y trabajar en equipo durante el curso? "
        	                  }
        	               ]
        	            }
        	         ],
        	         ...
        	         "questions":[
        	            {
        	               ...
        	               "rows":[
        	                  {
        	                     "value":"43",
        	                     "text":"¿Le tienes confianza al maestro para expresarle tus dudas, Preguntas y sugerencias?"
        	                  },
        	                  {
        	                     "value":"44",
        	                     "text":"¿Cuándo tienes una dificultad el maestro te apoya? "
        	                  },
        	                  {
        	                     "value":"45",
        	                     "text":"¿El salón de clases es un espacio seguro donde no son permitidas las agresiones de ningún tipo?"
        	                  },
        	                  {
        	                     "value":"46",
        	                     "text":"¿En el salón de clases te sientes respetada por el maestro? "
        	                  },
        	                  {
        	                     "value":"47",
        	                     "text":"¿Formas parte del grupo y te sientes integrada?"
        	                  },
        	                  {
        	                     "value":"48",
        	                     "text":"¿El maestro consigue que esta materia te interese?"
        	                  },
        	                  {
        	                     "value":"49",
        	                     "text":"¿El maestro es entusiasta y emprendedor con respecto a su materia?"
        	                  },
        	                  {
        	                     "value":"51",
        	                     "text":"¿El maestro optimiza los espacios - mueve las bancas, abre ventanas, ilumina, utiliza las paredes para pegar cosas- para favorecer el aprendizaje?"
        	                  }
        	               ]
        	            }
        	         ],
	...
	function sendDataToServer(survey) {
	    ...
	    $.ajax({
	    	...
	    	success: function(datos){
	    		...
	    		console.dir(datos);
	    		var urlComp = "/ev/"+evaluacion+"/co/"+conjunto+"/er/"+evaluador;
	    		var urlAsignaciones = url+"/evaluacion/evaluaciones"+urlComp;
